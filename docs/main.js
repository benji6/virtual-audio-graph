...
var createVirtualAudioGraph = function (ref) {
  if ( ref === void 0 ) ref = {};
...
var example3 = function () {
  ...
  var pingPongDelay = function (ref) {
    var decay = ref.decay;
    var delayTime = ref.delayTime;
  ...
  var oscillators = function (ref) {
    var currentTime = ref.currentTime; if ( currentTime === void 0 ) currentTime = virtualAudioGraph.currentTime;
    var notes = ref.notes;
    var noteLength = ref.noteLength;
  ...
  var up = Array.from({length: 16}, function (_, i) { return chromaticScale(i); });
  var down = [].concat( up ).reverse();
